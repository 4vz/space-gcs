...
namespace Telkomsat.checklistme.year
{
    public partial class data : System.Web.UI.Page
    {
        ...
        string Parameter = "a", query2 = "A", tanggalku = "s", value = "1", idtxt = "A", loop = "", ruangan, tipe, satuan, room, start, end, inisial, siang = "", tahun = "", tanggal1;
        string[] words = { "a", "a" };
        string[] akhir;
        ...
        void tablepersen()
        {
            ...
            if (dsheader.Tables[0].Rows.Count > 0)
            {
                for (int i = 0; i < dsheader.Tables[0].Rows.Count; ++i)
                {
                    ...
                    htmlTable2.Append($"<a class=\"link\" href=\"data.aspx?room={ruang}&tahun={tahun}\" style=\"font-size:12px;\">" + ruang + "</a>");
        ...
        void tableticket()
        {
            query = $@"select d.id_data, r.id_parameter, d.nilai, d.tanggal_kerja, p.Perangkat, r.satuan, p.sn, p.ruangan, r.parameter, r.tipe from checkme_datawmy d join checkme_parameterwmy r 
            ...
            htmlTable.Append("<tr><th>Ruangan</th><th>Perangkat</th><th>Serial Number</th><th>Parameter</th><th>Nilai</th><th>Tanggal Kerja</th></tr>");
            htmlTable.Append("</thead>");
            ...
            if (!object.Equals(ds.Tables[0], null))
            {
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    {
                        DateTime odate = Convert.ToDateTime(ds.Tables[0].Rows[i]["tanggal_kerja"].ToString());
                ...
                else
                {
                    if(Request.QueryString["room"] != null)
                    {
                        ...
                        lblkosong.Text = "Data tidak tersedia untuk " + room;
                    }
