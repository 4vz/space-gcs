...
namespace Telkomsat.checklistme.month
{
    public partial class dashboard : System.Web.UI.Page
    {
        ...
        string tanggal, waktu, tanggal1, ruangan, bulan, tahun, months, queryisi;
        DateTime wib;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            months = bulan[angka - 1];
            tahun = DateTime.Now.Year.ToString();
            tablepersen();
            lbltitle.Text = "Data Maintenance Bulan " + months + " " + tahun;
        }
        ...
        void tablepersen()
        {
            ...
            string style, class1, ruang, alias, querytotal;
