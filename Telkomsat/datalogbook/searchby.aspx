<%@ Page Title="Log Searchby" Language="C#" MasterPageFile="~/LOGBOOK.Master" AutoEventWireup="true" CodeBehind="searchby.aspx.cs" Inherits="Telkomsat.datalogbook.searchby" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:TextBox ID="txtprofile" Text="" runat="server" CssClass="hidden"></asp:TextBox>
...
<div class="row">
    ...
    <div class="tab-content no-padding">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                <div class="col-sm-2">
                    <label for="inputEmail3" class="pull-right">Pembuat</label>
                </div>   
                <div class="col-sm-10">
                    <asp:DropDownList ID="DropDownList1" runat="server" DataTextField="nama" DataValueField="id_profile" CssClass="form-control">
                        <asp:ListItem>kop</asp:ListItem>
                    </asp:DropDownList>
                </div>
            </div>
            <div class="form-group">
