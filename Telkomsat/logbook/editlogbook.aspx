<%@ Page Title="Edit" Language="C#" MasterPageFile="~/LOGBOOK.Master" AutoEventWireup="true" CodeBehind="editlogbook.aspx.cs" Inherits="Telkomsat.logbook.editlogbook" %>
    ...
    <div class="divtabel" style="margin-left:80px;">
        <table>
            ...
            <tr>
                ...
                <td class="auto-style1">
                    <asp:Button ID="Button1" runat="server" Text="Update" class="btn btn-default" Width="110px" OnClick="btnUpdate_Click" />
                </td>
            </tr>
        </table>
        <br />
