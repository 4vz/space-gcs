<%@ Page Title="Edit" Language="C#" MasterPageFile="~/LOGBOOK.Master" AutoEventWireup="true" CodeBehind="edit.aspx.cs" Inherits="Telkomsat.logbook.edit" %>
        ...
        <table>
            ...
            <tr>
                <td class="tdtext" style="padding-bottom:10px; padding-right:70px;">
                    <asp:Label ID="Label1" class="lbl" runat="server">Event <span class="spn"> * </span></asp:Label>
                </td>
            ...
            <tr>
                <td class="tdtext" style="padding-bottom:10px; padding-right:70px;">
                    <asp:Label ID="Label2" class="lbl" runat="server">Waktu Awal <span class="spn"> * </span></asp:Label>
                </td>
                <td style="padding-bottom:10px;" class="titikdua">
                ...
                <td class="tdtext" style="padding-bottom:10px; padding-right:30px; padding-left:82px;">
                    <asp:Label ID="Label6" class="lbl" runat="server">Waktu Selesai <span class="spn"> * </span></asp:Label>
                </td>
                <td style="padding-bottom:10px;" class="titikdua">
            ...
            <tr>
                ...
                <td class="auto-style1">
                    <asp:Button ID="btnSave" runat="server" Text="Update" class="btn btn-default" Width="110px" OnClick="btnUpdate_Click"/>
                </td>
            </tr>
            <tr>
        </table>
