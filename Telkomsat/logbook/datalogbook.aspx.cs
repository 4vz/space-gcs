...
{
    public partial class datalogbook : System.Web.UI.Page
    {
        string bulan;
        string tahun = "";
...

        {
            if (sqlCon.State == ConnectionState.Closed)
                sqlCon.Open();
            SqlCommand cmd = new SqlCommand("ViewAllSorting", sqlCon);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            Response.Write(kata1);
                SqlCommand cmd = new SqlCommand("CariLogbook", sqlCon);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        void tanggal()
        {
            if (sqlCon.State == ConnectionState.Closed)
                sqlCon.Open();
            SqlCommand cmd = new SqlCommand("CariTanggal", sqlCon);
            cmd.CommandType = CommandType.StoredProcedure;
