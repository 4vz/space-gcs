<%@ Page Title="" Language="C#" MasterPageFile="~/LOGBOOK.Master" AutoEventWireup="true" CodeBehind="tesuploadimg.aspx.cs" Inherits="Telkomsat.logbook.tesuploadimg" %>
   ...
   <div class="modal fade" id="modalupdate">
              ...
              <div class="modal-body">
                  <div class="row">
                      <div class="col-md-6">
                          <div class="form-group">
                            <label style="font-size:16px; font-weight:bold">Tanggal Awal :</label>
                             <input type="text" class="form-control pull-right" id="txtsdatelain" autocomplete="off" runat="server"/>
                        </div>
                      </div>
                      <div class="col-md-6">
                          <div class="form-group">
                            <label style="font-size:16px; font-weight:bold">Tanggal Akhir :</label>
                             <input type="text" class="form-control pull-right" id="txtedatelain" autocomplete="off" runat="server"/>
                        </div>
                      </div>
                      <div class="col-md-12">
                          <div class="form-group">
    ...
    <script>
        ...
        $('#<%=txtsdatekonf.ClientID%>').datepicker({
            ...
            var minDate = new Date(selected.date.valueOf());
            $('#<%=txtedatekonf.ClientID%>').datepicker('setStartDate', minDate);
        });
        $('#' + '<%=txtedatekonf.ClientID%>').datepicker({
            autoclose: true,
            format: 'yyyy/mm/dd',
            orientation: "bottom"
        }).on('changeDate', function (selected) {
            var minDate = new Date(selected.date.valueOf());
            $('#<%=txtsdatekonf.ClientID%>').datepicker('setEndDate', minDate);
            });
        ...
        $('#<%=txtsdatelain.ClientID%>').datepicker({
            autoclose: true,
            format: 'yyyy/mm/dd',
            orientation: "bottom"
        }).on('changeDate', function (selected) {
            var minDate = new Date(selected.date.valueOf());
            $('#<%=txtedatelain.ClientID%>').datepicker('setStartDate', minDate);
        });
        $('#' + '<%=txtedatelain.ClientID%>').datepicker({
            autoclose: true,
            format: 'yyyy/mm/dd',
            orientation: "bottom"
        }).on('changeDate', function (selected) {
            var minDate = new Date(selected.date.valueOf());
            $('#<%=txtsdatelain.ClientID%>').datepicker('setEndDate', minDate);
            });
