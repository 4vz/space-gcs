    ...
    public partial class viewharian : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                query = $@"select p.shelter, r.id_parameter, p.Perangkat, r.satuan, p.sn, r.parameter, r.tipe, d.data, d.tanggal from checkhk_parameter r left join
					...
					and '{tanggalku} 00:00:00' <= d.tanggal and d.tanggal < '{tanggalku} 23:59:59' where p.lokasi ='cbi'  order by p.shelter, p.rack, p.sn, r.id_parameter";
                tableticket();
            }
        ...
        protected void Filter_ServerClick(object sender, EventArgs e)
        {
            ...
            query = $@"select p.shelter, r.id_parameter, p.Perangkat, r.satuan, p.sn, r.parameter, r.tipe, d.data, d.tanggal from checkhk_parameter r left join
                    ...
                    where p.shelter = {room} and p.lokasi = 'cbi' order by p.shelter, p.rack, p.sn, r.id_parameter";
            tableticket();
        }
