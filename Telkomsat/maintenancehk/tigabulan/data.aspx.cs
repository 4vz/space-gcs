...
namespace Telkomsat.maintenancehk.tigabulan
{
    public partial class data : System.Web.UI.Page
    {
        ...
        string waktu, tanggal1, ruangan, triwulan, start, end, queryaft, snbbu, lokasibbu, perangkatbbu;
        int tahun;
        DateTime wib;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            triwulan = Request.QueryString["triwulan"];

            tablepersen();

            tablebaseband();

            lblwaktu.Text = "Data maintenance tahun " + tahun + " " + triwulan;  
            lblwaktubbu.Text = "Data maintenance baseband tahun " + tahun + " " + triwulan;
        }
            ...
            if (dsheader.Tables[0].Rows.Count > 0)
            {
                for (int i = 0; i < dsheader.Tables[0].Rows.Count; ++i)
                {
                    ...
                    queryisi = $@"SELECT count(*) as isi from mainhk_3m_data d join mainhk_3m_parameter r on
                                    ...
                                    d.tanggal < '{end} 23:59:59' and d.data_bef != '' and equipment='{equipment}' and triwulan='{triwulan}' group by equipment";
                    sqlcon.Open();
                    ...
                    htmltable.Append($"<a class=\"link\" href=\"viewdata.aspx?satelit={satelit}&lokasi={lokasi}&equipment={equipment}&tahun={tahun}&triwulan={triwulan}\" style=\"font-size:12px;\">" + lokasi + " -> " + satelit + " -> " + equipment + "</a>");
