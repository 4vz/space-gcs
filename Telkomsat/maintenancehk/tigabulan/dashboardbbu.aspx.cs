...
{
    public partial class dashboardbbu : System.Web.UI.Page
    {
        StringBuilder htmltable = new StringBuilder();
        StringBuilder mytable = new StringBuilder();
        SqlConnection sqlcon = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["GCSConnectionString"].ConnectionString);
        string tanggal, waktu, tanggal1, ruangan, triwulan, start, end, queryaft, lokasibbu, perangkatbbu, snbbu, sn;
        DateTime wib;
        ...
        void tablepersen()
        {
            ...
            string style, class1, satelit, alias, querytotal, queryisi, lokasi, equipment, kategori1;
            ...
            string queryheader = $@"select kategori1 from mainhk_bbu_parameter where sn='{sn}' group by kategori1";
            sqlcon.Open();
            ...
            if (dsheader.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    dsbar.Clear();
                    equipment = dsheader.Tables[0].Rows[i]["kategori1"].ToString();
                    ...
                    htmltable.Append($"<a class=\"link\" href=\"isibbu.aspx?equipment={equipment}&sn={sn}\" style=\"font-size:12px;\">" + equipment + "</a>");
