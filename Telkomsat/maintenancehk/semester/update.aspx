<%@ Page Title="Maintenance Semester" Language="C#" MasterPageFile="~/MAINTENANCEHK.Master" AutoEventWireup="true" CodeBehind="update.aspx.cs" Inherits="Telkomsat.maintenancehk.semester.update" %>
...
<div class="col-md-12 no-padding">
        ...
        <div class="box-footer no-padding">
            ...
            <asp:Button ID="Button1" runat="server" Text="Update" CssClass="btn-primary btn pull-right" Width="100px" OnClick="Button1_Click" />
            <!-- /.pull-right -->
            </div>
        </div>
        <!-- /.box-body -->
