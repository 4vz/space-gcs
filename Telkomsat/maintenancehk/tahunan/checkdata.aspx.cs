...
namespace Telkomsat.maintenancehk.tahunan
{
    public partial class checkdata : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                query = @"select tahun from maintenancehk_data d join maintenancehk_parameter r on d.id_parameter=r.id_parameter
                        join maintenancehk_perangkat t on t.id_perangkat=r.id_perangkat where t.jenis='TAHUNAN' group by tahun order by tahun desc";
                tableticket();
            }
        }
        ...
        void tableticket()
        {
            ...
            htmlTable.AppendLine("<tr><th>#</th><th>Tahun</th><th>Action</th></tr>");
            htmlTable.AppendLine("</thead>");
