<%@ Page Title="Spam" Language="C#" MasterPageFile="~/TICKETMASTER.Master" AutoEventWireup="true" CodeBehind="spam.aspx.cs" Inherits="Telkomsat.ticket.spam" %>
...
<asp:HiddenField ID="HiddenField1" runat="server" />
    ...
    <input type="button" value="display" id="btnsi" runat="server" onserverclick="disp_ServerClick" style="visibility:hidden"/>
