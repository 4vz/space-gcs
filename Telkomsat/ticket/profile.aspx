<%@ Page Title="" Language="C#" MasterPageFile="~/TICKETMASTER.Master" AutoEventWireup="true" CodeBehind="profile.aspx.cs" Inherits="Telkomsat.ticket.profile" %>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><asp:TextBox ID="txtnomorhp" TextMode="Number" runat="server" CssClass="form-control"></asp:TextBox></td>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                    <label style="font-size:16px; font-weight:bold">Nomor HP :</label>
                    <asp:TextBox ID="txtnomorhpmd" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
              </div>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $(data).each(function () {
                        ...
                        $('#<%=txtnomorhpmd.ClientID %>').val(this.no);
                    });
