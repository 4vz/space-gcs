...
{
    public partial class favorit : System.Web.UI.Page
    {
        SqlDataAdapter da;
        ...
        void tableticket()
        {
            ...
            if (Session["jenis1"].ToString() == "og" || Session["jenis1"].ToString() == "os")
                query = "SELECT * FROM ticket_user WHERE statusticket = 'favorit'";
            else
                query = $"SELECT * FROM ticket_user WHERE statusticket = 'favorit' and divisiuser = '{divisi}'";
