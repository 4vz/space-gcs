...
{
    public partial class semuaasset : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            gvContact.Columns[11].Visible = false;
            sqlCon.Open();
            SqlCommand countcmd = new SqlCommand("AsCountSemua", sqlCon);
        ...
        void fillGridView()
        {
            if (sqlCon.State == ConnectionState.Closed)
                sqlCon.Open();
            SqlCommand cmd = new SqlCommand("AsViewAllSort", sqlCon);
