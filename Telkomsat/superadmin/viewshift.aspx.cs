...
namespace Telkomsat.superadmin
{
    public partial class viewshift : System.Web.UI.Page
    {
        ...
        protected void lbnextt3s_Click(object sender, EventArgs e)
        {
            ...
            string query1 = $@"SELECT p.petugas,
            sum(case 
				when s.tanggal_shift = '2020-{bulan}-16' and s.jadwal = 'Pagi' then 1
				when s.tanggal_shift = '2020-{bulan}-16' and s.jadwal = 'Sore' then 2 else 0 end) as '01',
			sum(case 
				when s.tanggal_shift = '2020-{bulan}-17' and s.jadwal = 'Pagi' then 1
				when s.tanggal_shift = '2020-{bulan}-17' and s.jadwal = 'Sore' then 2 else 0 end) as '02',
			sum(case 
				when s.tanggal_shift = '2020-{bulan}-18' and s.jadwal = 'Pagi' then 1
				when s.tanggal_shift = '2020-{bulan}-18' and s.jadwal = 'Sore' then 2 else 0 end) as '03',
			sum(case 
				when s.tanggal_shift = '2020-{bulan}-19' and s.jadwal = 'Pagi' then 1
				when s.tanggal_shift = '2020-{bulan}-19' and s.jadwal = 'Sore' then 2 else 0 end) as '04',
			sum(case 
				when s.tanggal_shift = '2020-{bulan}-20' and s.jadwal = 'Pagi' then 1
				when s.tanggal_shift = '2020-{bulan}-20' and s.jadwal = 'Sore' then 2 else 0 end) as '05',
			sum(case 
				when s.tanggal_shift = '2020-{bulan}-21' and s.jadwal = 'Pagi' then 1
				when s.tanggal_shift = '2020-{bulan}-21' and s.jadwal = 'Sore' then 2 else 0 end) as '06',
			sum(case 
				when s.tanggal_shift = '2020-{bulan}-22' and s.jadwal = 'Pagi' then 1
				when s.tanggal_shift = '2020-{bulan}-22' and s.jadwal = 'Sore' then 2 else 0 end) as '07',
			sum(case 
				when s.tanggal_shift = '2020-{bulan}-23' and s.jadwal = 'Pagi' then 1
				when s.tanggal_shift = '2020-{bulan}-23' and s.jadwal = 'Sore' then 2 else 0 end) as '08',
			sum(case 
				when s.tanggal_shift = '2020-{bulan}-24' and s.jadwal = 'Pagi' then 1
				when s.tanggal_shift = '2020-{bulan}-24' and s.jadwal = 'Sore' then 2 else 0 end) as '09',
			sum(case 
				when s.tanggal_shift = '2020-{bulan}-25' and s.jadwal = 'Pagi' then 1
				when s.tanggal_shift = '2020-{bulan}-25' and s.jadwal = 'Sore' then 2 else 0 end) as '10',
			sum(case 
				when s.tanggal_shift = '2020-{bulan}-26' and s.jadwal = 'Pagi' then 1
				when s.tanggal_shift = '2020-{bulan}-26' and s.jadwal = 'Sore' then 2 else 0 end) as '11',
			sum(case 
				when s.tanggal_shift = '2020-{bulan}-27' and s.jadwal = 'Pagi' then 1
				when s.tanggal_shift = '2020-{bulan}-27' and s.jadwal = 'Sore' then 0 else 0 end) as '12',
			sum(case 
				when s.tanggal_shift = '2020-{bulan}-28' and s.jadwal = 'Pagi' then 1
				when s.tanggal_shift = '2020-{bulan}-28' and s.jadwal = 'Sore' then 2 else 0 end) as '13',
			sum(case
				when s.tanggal_shift = '2020-{bulan}-29' and s.jadwal = 'Pagi' then 1
				when s.tanggal_shift = '2020-{bulan}-29' and s.jadwal = 'Sore' then 2 else 0 end) as '14',
			sum(case 
				when s.tanggal_shift = '2020-{bulan}-30' and s.jadwal = 'Pagi' then 1
				when s.tanggal_shift = '2020-{bulan}-30' and s.jadwal = 'Sore' then 2 else 0 end) as '15'
		            FROM shiftme s
