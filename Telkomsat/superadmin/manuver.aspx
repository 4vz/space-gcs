<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manuver.aspx.cs" Inherits="Telkomsat.superadmin.manuver" %>
                            ...
                            <div class="box box-danger" style="min-height:90%">
                                ...
                                <div class="box-body">
                                    <div class="alert alert-success alert-dismissable" id="divsuccess" runat="server" visible="false">
                                        <span class="fa fa-check"> Berhasil ditambahkan</span>
                                    </div>
                                    <div class="form-group">
                                        <label style="font-size:16px; font-weight:bold">PIC Outsource :</label>
                                        <select class="form-control select2" data-placeholder="--Petugas--"
                                            style="width: 100%;" id="slos" runat="server">
                                            <option>Yosef</option>
                                            <option>Kamal</option>
                                            <option>Saipul</option>
                                            <option>Kosasih</option>
                                            <option>Wildan</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label style="font-size:16px; font-weight:bold">PIC Organik :</label>
                                        <select class="form-control select2" data-placeholder="--Petugas--"
                                            style="width: 100%;" id="slog" runat="server">
                                            <option>Halim</option>
                                            <option>Afis</option>
                                            <option>Budi</option>
                                            <option>Emil</option>
                                    ...
                                    <div class="bootstrap-timepicker">
                                        <div class="form-group">
                                          ...
                                          <div class="input-group">
                                            <input type="text" class="form-control timepicker" runat="server" id="txtjam1"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtketerangan" runat="server" autocomplete="off" CssClass="form-control"></asp:TextBox>
                                    </div>
                                    <div class="form-group">
