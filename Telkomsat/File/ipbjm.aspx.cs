...
{
    public partial class ipbjm : System.Web.UI.Page
    {
        string mystring;
        string sorting;
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("AdViewBJM   ", con);
        ...
        void session()
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("AdSearchBJM", con);
            if (urutkan.Value == "Host" && rbasc.Checked)
                sorting = "NAMAASC";
            else if (urutkan.Value == "Host" && rbdesc.Checked)
                sorting = "NAMADESC";
