<%@ Page Title="Filter" Language="C#" MasterPageFile="~/KnowledgeFIle.Master" AutoEventWireup="true" CodeBehind="filter2.aspx.cs" Inherits="Telkomsat.File.filter2" %>
...
<form id="form1" runat="server">
    ...
    <section class="content">
        ...
        <asp:GridView ID="gvFile" runat="server" AutoGenerateColumns="False" style="margin:0;" Font-Size="13px" BackColor="White"
            BorderColor="White" BorderStyle="None" BorderWidth="1px">
            <Columns>
