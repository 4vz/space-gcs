...
{
    public partial class cobain : System.Web.UI.Page
    {
        string mystring;
        string sorting;
        ...
        protected void linkDownloadFile1_Click(object sender, CommandEventArgs e)
        {
            lbltest.Text = ((sender as LinkButton).CommandArgument) + " " + " text " + ((sender as LinkButton).Text);
