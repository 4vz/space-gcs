<%@ Page Title="" Language="C#" MasterPageFile="~/KnowledgeFIle.Master" AutoEventWireup="true" CodeBehind="cobain.aspx.cs" Inherits="Telkomsat.File.cobain" %>
        ...
        <asp:GridView ID="gvFile" runat="server" AutoGenerateColumns="False" style="margin:0;" Font-Size="13px" BackColor="White"
            ...
            <Columns>
                <asp:TemplateField HeaderText="Nama File" ItemStyle-Width="300px">
                    <ItemTemplate>
                        <asp:LinkButton ID ="InkView1" runat ="server" Text='<%# Eval("ID") %>' CommandArgument='<%#Bind("ID") %>' OnCommand="linkDownloadFile1_Click"></asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Nama File" ItemStyle-Width="300px">
                    <ItemTemplate>
                        <asp:LinkButton ID ="InkView" runat ="server" Text='<%# Eval("NameFile") %>' CommandArgument='<%#Eval("ID") %>' ></asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
